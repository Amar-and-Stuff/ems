...
public class ManagerController {
    ...
    String updateEmployee(@PathVariable int manager_id,
            @RequestParam(name = "employee_id", required = true) int employee_id, Model model) {
    ...
    String updateEmployeeSubmisssion(@PathVariable int manager_id,
            @RequestParam(name = "employee_id", required = true) int employee_id, @ModelAttribute Employee employee,
            Model model) {
    ...
    String deleteEmployee(@PathVariable int manager_id,
            @RequestParam(name = "employee_id", required = true) int employee_id, Model model) {
